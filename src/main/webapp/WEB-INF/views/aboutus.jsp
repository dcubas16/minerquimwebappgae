			...
			<div class="row">
				...
				<div class="col-md-7">
					...
					<p class="lead">
						...
						aportarles soluciones que se traduzcan en ventajas competitivas
						para sus negocios. Desarrollamos nuestras actividades con
						crecimiento rentable de acuerdo con la política de mejoramiento
						continuo; con talento humano y valor agregado que satisfaga las
						expectativas de los clientes, permitiendo un reconocimiento
						satisfactorio para nuestros empleados.<br> Garantizamos un
						total respeto por la protección del medio ambiente, la ética y los
			...
			<div class="row">
				<div class="col-md-7">
					...
					<p class="lead">
						...
						el mercado nacional, preferidos por nuestros clientes por la
						calidad, servicio, funcionalidad y costo acordes con los más altos
						estándares internacionales. <br>Por consiguiente ser la
						columna vertebral de un grupo empresarial que en el Sector Químico
						genere con su gestión la mayor competitividad y permita el
